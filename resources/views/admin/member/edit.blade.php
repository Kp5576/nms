             ...
             <div class="form-group">
               ...
               <div class="form-group">
                  <div class="row mb-2">
                     ...
                     <div class="col-md-6 d-flex">
                        <input type="password" name="mail_password" value="{{ $user->mail_password }}" class="form-control" placeholder="Mail Password">
                     </div>                  
                  </div>
               </div>
               <hr/>
               ...
               <div class="form-group">
                  <div class="row mb-2">
                     <label class="col-md-3 form-label" for="">Retry (Seconds)</label>
                     <div class="col-md-6 d-flex">
