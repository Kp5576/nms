...
@section('content')
                                ...
                                <div class="col-xl-4 col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="javascript:void(0);" class="card-link mx-2">Another link</a>
                                        </div>
                                    </div>
                                </div><!-- COL END -->
                                <div class="col-xl-4 col-md-12">
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card ">
                                        ...
                                        <div class="card-body text-center">
                                            <span class="avatar avatar-xxl brround cover-image cover-image" data-bs-image-src="{{asset('build/assets/images/users/18.jpg')}}"></span>
                                        ...
                                        <div class="card-footer text-center">
                                            <div class="user-social-detail">
                                                <div class="">
                                                    <a href="javascript:void(0);"><i class="fa fa-facebook text-info" aria-hidden="true"></i></a>
                                                </div>
                                                <div class="">
                                                    <a href="javascript:void(0);" class="google-plus"><i class="fa fa-google-plus text-danger" aria-hidden="true"></i></a>
                                                </div>
                                                <div class="">
                                                    <a href="javascript:void(0);"><i class="fa fa-twitter text-info" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card m-b-20">
                                        ...
                                        <div class="card-body">
                                            <div class="visitor-list">
                                                ...
                                                <div class="media mt-2 pb-2 border-bottom align-items-center">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-xl-4">
                                    <div class="card card-blog-overlay1 border-0 br-7 overflow-hidden">
                                        <div class="card-body  text-white">
                                            <h3 class="card-title text-white">card-with image</h3>
                                            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum
                                        </div>
                                        <div class="card-footer border-transparet text-white z-index2">
                                            This is Basic card footer
                                        </div>
                                    </div>
                                </div><!-- COL END -->
                                <div class="col-md-4 col-xl-4">
                                    <div class="card card-blog-overlay2 border-0 br-7 overflow-hidden">
                                        <div class="card-body  text-white">
                                            <h3 class="card-title text-white">card-with image</h3>
                                            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum
                                        </div>
                                        <div class="card-footer text-white z-index2 border-transparet">
                                            This is Basic card footer
                                        </div>
                                    </div>
                                </div><!-- COL END -->
                                <div class="col-md-4 col-xl-4">
                                    <div class="card card-blog-overlay border-0 br-7 overflow-hidden">
                                        <div class="card-header z-index2 border-transparet ">
                                            <h3 class="card-title text-white ">card-with image</h3>
                                            <div class="card-options">
                                                <a href="javascript:void(0);" class="card-options-collapse" data-bs-toggle="card-collapse"><i class="fe fe-chevron-up text-white"></i></a>
                                                <a href="javascript:void(0);" class="card-options-remove" data-bs-toggle="card-remove"><i class="fe fe-x text-white"></i></a>
                                ...
                                <div class="col-md-6 col-xl-6">
                                    <div class="card card-aside">
                                        ...
                                        <a href="javascript:void(0);" class="card-aside-column br-tr-7 br-br-7 w-50" data-bs-image-src="{{asset('build/assets/images/media/2.jpg')}})"></a>
                                    </div>
                                </div><!-- COL END -->
                                <div class="col-md-6 col-xl-6">
                                    <div class="card card-aside bg-primary">
                                        ...
                                        <a href="javascript:void(0);" class="card-aside-column br-tr-7 br-br-7 w-50" data-bs-image-src="{{asset('build/assets/images/media/20.jpg')}})"></a>
                                    </div>
                                </div><!-- COL END -->
                                <div class="col-md-4 col-xl-4">
                                    <div class="card text-white bg-primary">
                                        <div class="card-header border-white-2">
