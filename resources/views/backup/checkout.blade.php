                            ...
                            <div class="row">
                                <div class="col-xl-8 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <button type="button" class="btn btn-success">Save and Deliver Here</button>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-pay">
                                                ...
                                                <div class="tab-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <span class="btn btn-success">
                                                                        <i class="fa fa-cc-visa text-white"></i> &nbsp; <i class="fa fa-cc-amex text-white"></i> &nbsp;
                                                                        <i class="fa fa-cc-mastercard text-white"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                    ...
                                                    <div class="tab-pane" id="tab21">
                                                        ...
                                                        <p><a href="javascript:void(0);" class="btn btn-success"><i class="fa fa-paypal"></i> Log in my Paypal</a></p>
                                ...
                                <div class="col-xl-4 col-md-12">
                                    <div class="card cart">
                                        ...
                                        <div class="card-footer">
                                            <a href="javascript:void(0);" class="btn btn-success">Deliver to this Address</a>
                                        </div>
                                    </div>
                                    <div class="card cart">
                                        <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            <div class="">
                                                <div class="d-flex">
                                                    <img class="avatar-xxl br-7" src="{{asset('build/assets/images/pngs/4.png')}}" alt="img">
                                                    <div class="ms-3">
                                                        <h4 class="mb-1 fw-semibold fs-14"><a href="{{url('shop-description')}}">Womens Bag</a></h4>
                                            ...
                                            <div class="mt-5">
                                                <div class="d-flex">
                                                    <img class="avatar-xxl br-7" src="{{asset('build/assets/images/pngs/6.png')}}" alt="img">
                                                    <div class="ms-3">
                                                        <h4 class="mb-1 fw-semibold fs-14"><a href="{{url('shop-description')}}">Ear Pods</a></h4>
                                                        <div class="text-warning fs-14">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                            ...
                                            <div class="mt-5">
                                                <div class="d-flex">
                                                    <img class="avatar-xxl br-7" src="{{asset('build/assets/images/pngs/5.png')}}" alt="img">
                                                    <div class="ms-3">
                                                        <h4 class="mb-1 fw-semibold fs-14"><a href="{{url('shop-description')}}">Modern Chair</a></h4>
                                                        <div class="text-warning fs-14">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                            ...
                                            <ul class="list-group border br-7 mt-5">
                                                ...
                                                <li class="list-group-item border-0 fw-bold h4">
                                                    Total
                                        ...
                                        <div class="card-footer text-end">
                                            <input type='button' class="btn btn-success" value='Place Order' id='click-payment'>
                                        </div>
                                    </div>
                                </div>
                            </div>
