...
@section('content')
      ...
      <!-- PAGE-HEADER -->
        <div class="page-header">
            <h1 class="page-title">Manage Customer Member</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Manage Customer Member</li>
            </ol>
        </div>
        <!-- PAGE-HEADER END -->
                                        ...
                                        {{ $loop->iteration }}
                                            ...
                                            <td> 
                                                <a href="javascript:void(0);" data-bs-toggle="modal" rel="{{$record->id}}" data-bs-target="#editMyModal" class="btn btn-primary-light edit-record border-0 me-3 " data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="icon icon-pencil align-middle"></i></a>
                                                 ...
                                                 <form method="post"  action="{{ route('admin.customer.member.delete',['id' => $record->id]) }}" style="display:inline">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="modal" id="myModal">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Add Customer Member</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>

                            <!-- Modal body -->
                            <div class="modal-body">
                                <form action="{{route('admin.customer.member.create')}}" method="post">
                                    @csrf
                      ...
                      <div class="modal" id="editMyModal">
                        <div class="modal-dialog">
                            ...
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title">Edit Customer Member</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>

                            <!-- Modal body -->
                            <div class="modal-body">
                                 <form action="{{route('admin.customer.member.update')}}" method="post">
                                    @method('put')
                                    @csrf 
                                    <div class="form-group">
                                        <label>Name</label>
