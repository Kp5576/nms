                                                    ...
                                                    <table class="table table-bordered table-vcenter text-nowrap">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);" class="btn btn-primary-light border-0 me-3 " data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="icon icon-heart align-middle"></i></a>
