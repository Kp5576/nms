...
@section('content')
      ...
      <!-- PAGE-HEADER -->
        <div class="page-header">
            <h1 class="page-title">Manage Agent's</h1>
            <ol class="breadcrumb">
                                        ...
                                        {{ $loop->iteration }}
                                            ...
                                            <td> 
                                               <a href="javascript:void(0);" data-bs-toggle="modal" rel="{{$record->id}}" data-bs-target="#editMyModal" class="btn btn-primary-light edit-record border-0 me-3 " data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="icon icon-pencil align-middle"></i></a>
                                                ...
                                                <form method="post"  action="{{ route('admin.agent.delete',['id' => $record->id]) }}" style="display:inline">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <td> <a  class="btn btn-success" href="{{route('admin.agent.member.list' ,['id' => $record->id])}}">Agent List</a> </td>
                                        </tr>
                                        </tr> 
                                        @endforeach
                                    </tbody>
