         ...
         <form action="{{route('admin.nms.update')}}" method="POST">
            ...
            <div class="card-body">
               <div class=" row mb-2">
                  ...
                  <div class="col-md-6">
                     <select name="member_id" required class="form-control" disabled>
               ...
               <div class="form-group">
                  <div class=" row mb-2">
                     ...
                     <div class="col-md-6">
                        <select name="isp_id" required class="form-control" id="select_user" disabled>
                        <option value="">Select Option</option>
               ...
               <div class="form-group">
                  <div class=" row mb-2">
                     ...
                     <div class="col-md-6">
                        <select name="customer_id" required class="form-control" disabled>
                        <option value="">Select Option</option>
                           @foreach($customer as $result)
                           <option  value="{{$result->id}}" {{ $result->id == $nms->customer_id ? 'selected' : ''  }}>{{$result->name}}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
               ...
               <div class="form-group">
                  <div class=" row mb-2">
                     ...
                     <div class="col-md-6">
                        <select name="agent_id" required class="form-control" disabled>
                        <option value="">Select Option</option>
