...
@section('content')
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                                    <option value="br" data-data="{&quot;image&quot;: &quot;{{asset('build/assets/images/flags/br.svg')}}&quot;}">Brazil</option>
                                                    <option value="cz" data-data="{&quot;image&quot;: &quot;{{asset('build/assets/images/flags/cz.svg')}}&quot;}">Czech Republic</option>
                                                    <option value="de" data-data="{&quot;image&quot;: &quot;{{asset('build/assets/images/flags/de.svg')}}&quot;}">Germany</option>
                                                    <option value="pl" data-data="{&quot;image&quot;: &quot;{{asset('build/assets/images/flags/pl.svg')}}&quot;}" selected="">Poland</option>
                                                </select>
                                            </div>
                                            <div class="mb-4">
                                ...
                                <div class="col-xl-12">
                                    <div class="card form-input-elements">
                                        <div class="card-header">
                                            <h3 class="card-title">Bootstrap File Inputs</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <input type="file" class="dropify" data-default-file="{{asset('build/assets/images/media/1.jpg')}}" data-height="300" >
                                        </div>
                                    </div>
                                </div><!-- COL END -->
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <button class="btn btn-primary py-1 px-4">Submit</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
		...
		<script src="{{asset('build/assets/plugins/intl-tel-input-master/intlTelInput.js')}}"></script>
		<script src="{{asset('build/assets/plugins/intl-tel-input-master/country-select.js')}}"></script>
		<script src="{{asset('build/assets/plugins/intl-tel-input-master/utils.js')}}"></script>
		...
		<!-- DATEPICKER JS -->
		<script src="{{asset('build/assets/plugins/date-picker/spectrum.js')}}"></script>
