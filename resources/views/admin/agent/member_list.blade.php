...
@section('content')
      ...
      <!-- PAGE-HEADER -->
        <div class="page-header">
            <h1 class="page-title">Manage Agent Member</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Manage Agent Member</li>
            </ol>
        </div>
        <!-- PAGE-HEADER END -->
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card cart">
                        <div class="card-header">
                            <h3 class="card-title">Agent Member List</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-vcenter text-nowrap" id="basic-datatable2">
                                    ...
                                    <tbody>
                                        ...
                                        {{ $loop->iteration }}
                                            ...
                                            <td class="font-weight-bold">{{ $record->agent->name}}</td>
                                            ...
                                            <td> 
                                                <a href="javascript:void(0);" data-bs-toggle="modal" rel="{{$record->id}}" data-bs-target="#editMyModal" class="btn btn-primary-light edit-record border-0 me-3 " data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="icon icon-pencil align-middle"></i></a>
                                                 ...
                                                 <form method="post"  action="{{ route('admin.agent.member.delete',['id' => $record->id]) }}" style="display:inline">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="modal" id="myModal">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Add Agent Member</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>

                            <!-- Modal body -->
                            <div class="modal-body">
                                <form action="{{route('admin.agent.member.create')}}" method="post">
                                    @csrf
                      ...
                      <div class="modal" id="editMyModal">
                        <div class="modal-dialog">
                            ...
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title">Edit Agent Member</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>

                            <!-- Modal body -->
                            <div class="modal-body">
                                <form action="{{route('admin.agent.member.update')}}" method="post">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        <label>Name</label>
