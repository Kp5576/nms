                                            ...
                                            <div class="text-wrap">
                                                ...
                                                <div class="example">
                                                    <div class="btn-list">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-success">Primary</a>
                                                        <a href="javascript:void(0);" class="btn btn-secondary">Secondary</a>
                                                        <a href="javascript:void(0);" class="btn btn-success">Success</a>
                                                        <a href="javascript:void(0);" class="btn btn-info">Info</a>
                                                        <a href="javascript:void(0);" class="btn btn-warning">Warning</a>
                                                        <a href="javascript:void(0);" class="btn btn-danger">Danger</a>
                                                        <a href="javascript:void(0);" class="btn btn-link shadow-none border-0">Link</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="btn-list">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown">
                                                                <i class="fe fe-calendar me-2 d-inline-flex"></i>Show calendar
                                                            </button>
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                                                <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="text-wrap">
                                                <p>Use any of the available in <code class="highlighter-rouge">.btn-group</code> classes to quickly create a styled button.</p>
                                                <div class="example">
                                                    <div class="btn-group">
                                                        <a href="javascript:void(0);" class="btn btn-success">Left</a>
                                                        <a href="javascript:void(0);" class="btn btn-success">Middle</a>
                                                        <a href="javascript:void(0);" class="btn btn-success">Right</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="example">
                                                    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                        <div class="btn-group me-2 mb-1">
                                                            <a href="javascript:void(0);" class="btn btn-success">1</a>
                                                            <a href="javascript:void(0);" class="btn btn-success">2</a>
                                                            <a href="javascript:void(0);" class="btn btn-success">3</a>
                                                            <a href="javascript:void(0);" class="btn btn-success">4</a>
                                                        </div>
                                                        <div class="btn-group me-2 mb-1">
                                                            <a href="javascript:void(0);" class="btn btn-secondary">5</a>
                                                            <a href="javascript:void(0);" class="btn btn-secondary">6</a>
                                                            <a href="javascript:void(0);" class="btn btn-secondary">7</a>
                                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="text-wrap">
                                                ...
                                                <div class="example">
                                                    <div class="btn-list">
                                                        <a href="javascript:void(0);" class="btn btn-primary w-xs mb-1">Min-XS</a>
                                                        <a href="javascript:void(0);" class="btn btn-secondary w-sm mb-1">Min-SM</a>
                                                        <a href="javascript:void(0);" class="btn btn-danger w-md mb-1">Min-MD</a>
                                                        <a href="javascript:void(0);" class="btn btn-success w-lg mb-1">Min-LG</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
