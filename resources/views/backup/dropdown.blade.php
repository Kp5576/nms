                                            ...
                                            <div class="example panel panel-default">
                                                <div class="panel-body p-0">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-primary dropdown-toggle border-end-white-2" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        <button type="button" class="btn btn-success">Action</button>
                                                        <button type="button" class="btn btn-success dropdown-toggle border-end-white-2" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-info dropdown-toggle border-end-white-2" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-warning dropdown-toggle border-end-white-2" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-danger dropdown-toggle border-end-white-2" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <div class="example panel panel-default">
                                                <div class="panel-body p-0">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-pill btn-primary border-end-white-2 dropdown-toggle" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-pill btn-success border-end-white-2 dropdown-toggle" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-pill btn-info border-end-white-2 dropdown-toggle" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-warning btn-pill border-end-white-2 dropdown-toggle" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        ...
                                                        <button type="button" class="btn btn-pill btn-danger border-end-white-2 dropdown-toggle" data-bs-toggle="dropdown">
                                                            <span class="caret"></span>
                                                            <span class="sr-only">Toggle Dropdown</span>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                        ...
                                        <div class="card-body">
                                            <div class="example panel panel-default">
                                                <div class="panel-body p-0">
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        <button type="button" class="btn btn-vimeo btn-pill dropdown-toggle" data-bs-toggle="dropdown">
