                                            ...
                                            <div class="example">
                                                <div class="row text-center">
                                                    <div class="col-md-3 mt-2 mb-2">
                                                        <button type="button" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Tooltip on top">Tooltip on top</button>
                                                    </div>
                                                    <div class="col-md-3 mt-2 mb-2">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="example">
                                                <div class="row text-center">
                                                    <div class="col-md-3 mt-2 mb-2">
                                                        <button type="button" class="btn btn-success" data-bs-toggle="tooltip-primary" data-bs-placement="top" title="Tooltip on top">Tooltip on top</button>
                                                    </div>
                                                    <div class="col-md-3 mt-2 mb-2">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="example">
                                                <div class="row text-center">
                                                    <div class="col-sm-6 col-lg-3 mt-2 mb-2">
                                                        <button class="btn btn-success" data-bs-container="body" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-placement="top" data-bs-popover-color="head-primary" title="Popover top">Click me</button>
                                                    </div><!-- col-3 -->
                                                    <div class="col-sm-6 col-lg-3 mt-2 mb-2">
