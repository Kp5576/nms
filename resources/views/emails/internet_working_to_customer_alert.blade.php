...
<head>
    ...
    <title>Internet Link Working Alert</title>
        ...
        <div class="row">
            <div class="col-md-6" style="margin: 0 auto;background-color: #f4f4f4">
                <div class="forget-password-form" style="text-align: center; padding: 2rem; border: 1px solid #ccc; border-radius: 5px;">
                    ...
                    <p style="color: #666;">Internet Link Working</p>
                    <form>
                        <div class="mb-3">
                            <table style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
                                <tbody>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left;">Dear Customer</td>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">{{ $postdata[0] }}</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left;">Username / IP</td>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">{{ $postdata[1] }}</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left;">Branch Name</td>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">{{$postdata[2]}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left;">Branch Address</td>
                                     <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">{{$postdata[3]}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left;">Link Working From </td>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">{{$postdata[4]}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left">Regards & Thanks Team </td>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">{{$postdata[5]}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #ccc; padding: 0.5rem; font-weight: bold; text-align: left;">Mobile</td>
